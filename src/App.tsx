...
function App() {
  ...
  return (
    <div>
      ...
      <h1 className="w-auto mx-auto text-center text-white font-extrabold mt-20 text-4xl tracking-wider">
        Ryans URL shortener
      </h1>
      <p className="flex pt-4 text-gray-500 font-light w-2/3 justify-center content-center mx-auto">
        RB.GY is a free tool to shorten URLs powered by Rebrandly. Create short
      ...
      <div className="flex h-auto flex-col w-2/3 mx-auto rounded-lg items-center mt-8">
        <div className="flex flex-col justify-evenly">
          <div className="items-center gap-3 mb-10 flex">
            <input
              className="w-96 pl-3 my-auto rounded-md h-12 text-lg "
            ...
            ></input>
            <button
              className="border-solid my-auto rounded-md border-blue-400 text-white bg-blue-400 h-12 border-2 p-2"
              onClick={createUrl}
            >
              Shorten URL
            </button>
